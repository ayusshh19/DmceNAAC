    ...
    <section class="content-container">
        ...
        <div data-aos="fade-up" class="container">
            ...
            <div class="container-fluid naac-extra-tab my-3 mt-4 py-3 pt-4">
                <a href="<?php echo $address ?>NAAC/naac">NAAC</a>
                <a href="https://dmce.ac.in/main-website/files/naac/iiqa/iiqa.pdf">IIQA</a>
                <a href="<?php echo $address ?>NAAC/ssr">SSR</a>
                <a href="<?php echo $address ?>NAAC/criterion1">CRITERION 1</a>
                <a href="<?php echo $address ?>NAAC/criterion2">CRITERION 2</a>
                <a href="<?php echo $address ?>NAAC/criterion3">CRITERION 3</a>
                <a href="<?php echo $address ?>NAAC/criterion4">CRITERION 4</a>
                <a href="<?php echo $address ?>NAAC/criterion5">CRITERION 5</a>
                <a href="<?php echo $address ?>NAAC/criterion6">CRITERION 6</a>
                <a href="<?php echo $address ?>NAAC/criterion7">CRITERION 7</a>
                <a href="<?php echo $address ?>NAAC/extended-profile">EXTENDED PROFILE</a>
                <a href="<?php echo $address ?>NAAC/dvv-clarification.php">DVV CLARIFICATION</a>
                <a href="<?php echo $address ?>NAAC/best-practices">BEST PRACTICES</a>
                <a href="<?php echo $address ?>NAAC/hr-policy-manual">HR POLICY MANUAL</a>
                <a href="<?php echo $address ?>NAAC/awards">AWARDS AND RECOGNITION</a>
                <a href="<?php echo $address ?>NAAC/environmental-activities">ENVIRONMENTAL ACTIVITIES</a>
                <a href="<?php echo $address ?>NAAC/stake-holders-feedback">STAKE HOLDERS FEEDBACK</a>
                <a href="<?php echo $address ?>NAAC/institutional-distinctiveness">INSTITUTIONAL DISTINCTIVENESS</a>
                <a href="<?php echo $address ?>NAAC/disabled-friendly-campus">DISABLED FRIENDLY CAMPUS</a>
                <a href="<?php echo $address ?>NAAC/capacity-building">CAPACITY BUILDING AND SKILL ENHANCEMENT</a>
                <a href="#">INTERNAL AND EXTERNAL AUDIT</a>
                <a href="<?php echo $address ?>NAAC/value-added">VALUE ADDED COURSE</a>
            </div>
            <!-- NAAC TABS -->
            ...
            <div class="tab-content cotainer">
                <div class="tab-pane table-content active">
                    <?php echo $content ?>
                </div>
